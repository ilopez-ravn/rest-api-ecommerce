    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/orders/*/refunds").hasAnyRole("CLIENT", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/refunds").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/refunds/*/status").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/refunds/*/return-shipping").hasRole("CLIENT")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/refunds/*/product-received").hasAnyRole("MANAGER", "WAREHOUSE")
